<x-jet-dialog-modal wire:model="visible">
  ...
  <x-slot name="content">
    ...
    <x-jet-input wire:model="name" name="name" type="text" class="w-full my-2" placeholder="Nombre de la tienda" />
    <x-jet-label class="text-base">Dirección</x-jet-label>
    <x-jet-input wire:model="address" name="address" type="text" class="w-full my-2"
      placeholder="Direccion de la tienda" />
    <x-jet-label class="text-base">Teléfono</x-jet-label>
    <x-jet-input wire:model="phone" name="phone" type="number" class="w-full my-2"
