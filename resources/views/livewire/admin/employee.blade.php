<div>
    ...
    <div class="mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-10 grid grid-row-3">
        ...
        <x-employee.table>
          ...
          <tr>
            <td class="border p-5">{{$user->name}}</td>
            <td class="border p-5">{{$user->email}}</td>
            <td class="text-center border p-5">
              <div class="grid grid-cols-4">
                <div class="text-center col-start-2" wire:click="edit({{$user->id}})">
                ...
                <div class="text-red-500" wire:click="delete({{$user->id}})">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <x-employee.modal :createUser='$createUser'/>
</div>